...
{0x10,0,217,1,LabelDef::DataType::UNKNOWN,"Operation Mode"},
...
{0x21,0,105,2,LabelDef::DataType::CURRENT,"INV primary current (A)"},
//{0x21,2,105,2,-1,"INV secondary current (A)"},
{0x21,4,101,2,LabelDef::DataType::VOLTAGE,"Voltage (N-phase) (V)"}, // sanitmarek
...
{0x60,2,302,1,LabelDef::DataType::UNKNOWN,"Freeze Protection"},
...
{0x61,2,105,2,LabelDef::DataType::TEMPERATURE,"Leaving water temp. before BUH (R1T)"},
//{0x61,4,105,2,1,"Leaving water temp. after BUH (R2T)"},
//{0x61,6,105,2,1,"Refrig. Temp. liquid side (R3T)"},
{0x61,8,105,2,LabelDef::DataType::TEMPERATURE,"Inlet water temp.(R4T)"},
{0x61,10,105,2,LabelDef::DataType::TEMPERATURE,"DHW tank temp. (R5T)"},
...
{0x62,9,105,2,LabelDef::DataType::FLOW,"Flow sensor (l/min)"},
